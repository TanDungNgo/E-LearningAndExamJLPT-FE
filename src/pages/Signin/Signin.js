            ...
            <form className={cx("login-form")} onSubmit={handleLogin}>
              <div className={cx("login-form__content")}>
                ...
                <div className={cx("login-form__item")}>
                  <div className={cx("login-form__checkbox")}>
                    ...
                    <label
                      ...
                      className={cx("login-form__checkboxLable")}
                    >
                      Remember Me
                    </label>
                    <a href="#" className={cx("login-form__fp-link")}>
                      Forget password?
                    </a>
                  </div>
                </div>
                ...
                <div className={cx("login-form__button")}>
                  <Button primary type="submit" className={cx("btn-login")}>
                    Login
                  </Button>
                </div>
              ...
              <Button
                ...
                className={cx("btn-gg")}
                leftIcon={
                  <FontAwesomeIcon icon={faGoogle} className={cx("icon-gg")} />
                }
              >
