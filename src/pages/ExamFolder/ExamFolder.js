      ...
      <div className={cx("exam-folder__container")}>
        ...
        <div className={cx("container__choice-exam__group")}>
          <div className={cx("container__choice-exam__group__list")}>
            <div className={cx("container__choice-exam__group__list__exam")} onClick={handleClickExam}>
              <img className={cx("container__choice-exam__group__list__exam__image")} src="/images/N5.png" alt="" />
            </div>
            <div className={cx("container__choice-exam__group__list__exam")} onClick={handleClickExam}>
              <img className={cx("container__choice-exam__group__list__exam__image")} src="/images/N4.png" alt="" />
            </div>
            <div className={cx("container__choice-exam__group__list__exam")} onClick={handleClickExam}>
              <img className={cx("container__choice-exam__group__list__exam__image")} src="/images/N3.png" alt="" />
            </div>
            <div className={cx("container__choice-exam__group__list__exam")} onClick={handleClickExam}>
              <img className={cx("container__choice-exam__group__list__exam__image")} src="/images/N2.png" alt="" />
            </div>
            <div className={cx("container__choice-exam__group__list__exam")} onClick={handleClickExam}>
              <img className={cx("container__choice-exam__group__list__exam__image")} src="/images/N1.png" alt="" />
            </div>
          </div>
        </div>
        {/* </Link> */}
        ...
        <div className={cx("exam-folder__honors-student")}>
          <div className={cx("exam-folder__honors__container-list")}>
            <div className={cx("exam-folder__honors__list-student1")}>
              <img src="https://riki.edu.vn/online/design-jlpt/images/jlpt102022/1.png" className={cx("exam-folder__honors__img1")}></img>
            </div>
            <div className={cx("exam-folder__honors__list-student2")}>
              <img src="https://riki.edu.vn/online/design-jlpt/images/jlpt102022/2.png" className={cx("exam-folder__honors__img2")}></img>
            </div>
          ...
          <div>
            ...
            <div className={cx("modal__content")}>
              <div className={cx("modal__container-time")}>
                <FontAwesomeIcon icon={faClock} className={cx("modal__icon-time")}/>
                <div className="modal__time"> 105 Minutes</div>
              </div>
              
              <div className={cx("modal__container-user")}>
                <FontAwesomeIcon icon={faUser} className= {cx("modal__icon-user")}/>
